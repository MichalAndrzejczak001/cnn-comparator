...
def load_dataset(name: str, batch_size: int) -> Tuple[DataLoader, DataLoader, int, int, tuple]:
    if name == "mnist":
        ...
        return DataLoader(train, batch_size=batch_size, shuffle=True), DataLoader(test, batch_size=batch_size), 10, 1, (32, 32)
        ...
        return DataLoader(train, batch_size=batch_size, shuffle=True), DataLoader(test, batch_size=batch_size), 10, 3, (32, 32)
